...
# DATE:     05/27/2011                                                                    
# AUTHOR:   R. Valliant                                                                   
# PURPOSE:  Figure 15.1 to illustrate estimating SEs & CIs with Rao-Wu bootstrap         
#*****************************************************************************************
...
postscript("C:\\Projects\\Practical Tools Book\\Book Chapters\\15 Variance Estimation\\Examples\\Fig 15.1.eps",
           width=6,
           height=8)
