#**************************************************************************************************************
# FILE :   C:\Projects\Practical Tools Book\Book Chapters\14 Steps in Weighting\Examples\propensity.classes.R  
...
#attach("I:\\Projects\\Practical Tools\\Data\\nhis.RData",pos=2)
            ...
            # Note that regressions in binary.reg.R must be run to create pred.logit, etc before running 
            # code below
