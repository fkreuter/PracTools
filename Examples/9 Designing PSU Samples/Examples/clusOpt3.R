...
clusOpt3 <- function(unit.cost, delta1, delta2, unit.rv, CV0=NULL, tot.cost=NULL, cal.sw){
    ...
    output                   
        ...
        # test cal.sw=1,2
        # Example 9.6
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=1, tot.cost=100000,cal.sw=1)      
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=1, CV0=0.01,cal.sw=2)      
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.03, delta2=0.10, unit.rv=1, CV0=0.01,cal.sw=2)      


        # error check on cal.sw=1 & tot.cost=NULL
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=1, cal.sw=1)      
        # error check on cal.sw=2 & CV0=NULL
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=1, cal.sw=2)      
        # test non-null input for CV0 and tot.cost
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=1, cal.sw=2, CV0=0.05, tot.cost=15000)      

            
        # vector input for one parameter
        # Example 9.6
clusOpt3(unit.cost=c(500, 100, 120), delta1=c(0.01,0.05,0.10), delta2=0.10, unit.rv=2, tot.cost=100000,cal.sw=1)   
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=c(0.01,0.05,0.10), unit.rv=2, tot.cost=100000,cal.sw=1)   
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=c(1,2,5), tot.cost=100000,cal.sw=1)   
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=2, tot.cost=c(100000,250000),cal.sw=1)   

clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=0.10, unit.rv=2, CV0=c(0.01, 0.10),cal.sw=2)   

        # Test error msg for vector input
clusOpt3(unit.cost=c(500, 100, 120), delta1=c(0.01,0.05), delta2=0.10, unit.rv=2, CV0=c(0.01, 0.10),cal.sw=2)   
clusOpt3(unit.cost=c(500, 100, 120), delta1=c(0.01,0.05), delta2=c(0.05,0.10), unit.rv=2, CV0=c(0.01, 0.10),cal.sw=2)   
clusOpt3(unit.cost=c(500, 100, 120), delta1=0.01, delta2=c(0.05,0.10), unit.rv=1:2, CV0=c(0.01, 0.10),cal.sw=2)   
clusOpt3(unit.cost=c(500, 100, 120), delta1=c(0.01,0.05,0.10), delta2=0.10, unit.rv=2, tot.cost=100,cal.sw=1)   
